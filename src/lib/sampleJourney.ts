...
export const sampleJourney: Journey = {
  ...
  routes: [
    ...
    },
    {
      ...
      colleges: [
        {
          name: "University of Delhi — B.Com",
          type: "government",
          location: "Delhi",
          approxAnnualFees: "₹10,000–25,000 / year",
          feesNote: "approximate — confirm on official site",
          entranceRequired: "Merit via CUET-UG",
          costBand: "low",
        ...
        },
        {
          ...
          approxAnnualFees: "₹45,000–95,000 / year",
          feesNote: "approximate — confirm on official site",
          entranceRequired: "Entrance test + interview",
          costBand: "mid",
          officialUrl: "https://www.christuniversity.in/",
          verified: false,
        },
      ],
      missedDeadlineFallback: {
