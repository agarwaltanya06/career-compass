...
export default function JourneyPage() {
  ...
  // when opened directly (e.g. the "see a sample" link).
    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <section className="mt-6">
        ...
        <div className="mt-4 space-y-6">
          {filteredRoutes.map(({ route, exams, colleges }, i) => (
            <CollapsibleRoute
              key={route.id}
              route={route}
              exams={exams}
              ...
              // First route open so something's visible at a glance; the rest
              // start collapsed so several paths are easy to scan and compare.
              defaultOpen={i === 0}
            />
          ))}
        </div>
...
/**
 * One career route, rendered as a collapsible card: a clickable summary header
 * (name + cost/feasibility + "best for") with a chevron, and a body (timeline,
 * exports, skills, exam/college cards, fallback) that expands on demand. Keeping
 * the body collapsible lets a student scan and compare several paths at once.
 */
    ...
    <article className="overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-sm">
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 20 20"
          fill="currentColor"
          className={`mt-1 h-5 w-5 shrink-0 text-stone-400 transition-transform ${
            open ? "rotate-180" : ""
          }`}
        >
          <path
